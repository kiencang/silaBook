<task>
**LỆNH THỰC THI CHÍNH:** 
Dựa trên vai trò và toàn bộ quy tắc đã được nạp trong **System Instructions (SI)**, bạn hãy dịch nội dung đoạn trích sách (định dạng Markdown) được cung cấp dưới đây sang tiếng Việt.
</task>
