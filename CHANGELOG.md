...
## [v1.0.109]- 2026-09-07
### Fixed
- Chỉnh sửa nhỏ cho SI/Prompt cho mục đích tóm tắt chunk.

## [v1.0.108]- 2026-09-07
### Fixed
- Cập nhật SI/Prompt cho mục đích tóm tắt chunk. Điều chỉnh để nó tập trung và thống nhất hơn;
...
## [v1.0.99]- 2026-07-24
### Fixed
- Chỉnh lại một số câu chữ cho dễ hiểu hơn (tooltip tải các định dạng, khuyến khích vào lại app gốc để remix phiên bản mới);

## [v1.0.98]- 2026-07-19
### Fixed
- Điều chỉnh lại câu chữ trong phase `Chia chương` và `Dịch` để người dùng hiểu rõ hơn (không điều chỉnh tính năng nào);

## [v1.0.97]- 2026-07-19
### Fixed
- Điều chỉnh câu chữ ở phase `Chia chương` và `Dịch`;
...
## [v1.0.94]- 2026-07-08
### Fixed
- Tinh chỉnh nhỏ cho giao diện (căn logo, mức bo góc button, hover một số card của ứng dụng dịch khác);
...
## [v1.0.85]- 2026-06-29
### Fixed
- Thêm link video hướng dẫn sử dụng ngay ở phần trang chủ;

## [v1.0.84]- 2026-06-29
### Fixed
- Thêm link video hướng dẫn sử dụng PaddleOCR để chuyển PDF sang Markdown, và giữ được ảnh;
...
## [v1.0.81]- 2026-06-12
### Fixed
- Cập nhật SI/Prompt dịch tài liệu học thuật;
...
## [v1.0.77]- 2026-06-09
### Fixed
- Loại bỏ các liên kết nội bộ khỏi dữ liệu gốc. Nó đặc biệt gây nhiễu và khó xử lý;
- Vô hiệu hóa 3 button ở phía trái footer trong quá trình dịch;

## [v1.0.76]- 2026-06-08
### Fixed
- Chuyển đổi sang docx tốt hơn (chú thích chuẩn hơn);

## [v1.0.75]- 2026-06-07
### Fixed
- Thêm chỉ dẫn tốt hơn về việc nên dùng EPUB để dịch và công cụ chuyển đổi PDF sang EPUB;
- Thêm modal về các công cụ dịch thuật hữu ích khác;

## [v1.0.74]- 2026-06-06
### Fixed
- Thêm tính năng tải định dạng sách EPUB;
- Thêm tính năng tải định dạng DOCX, có thể chỉnh sửa;

## [v1.0.73]- 2026-06-06
### Fixed
- Thêm tính năng tải file PDF;
